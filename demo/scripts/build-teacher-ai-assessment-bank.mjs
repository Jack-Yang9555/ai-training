...
const bankPath = path.join(demoDir, "docs", "data", "高职教师AI认知测评题库.json");
const htmlPath = path.join(demoDir, "docs", "高职教师AI认知测评Demo.html");
const markdownPath = path.join(demoDir, "docs", "高职教师AI认知测评题库.md");
...
if (requestedModes.some((mode) => !validModes.has(mode)) || requestedModes.length > 1) {
  throw new Error("用法：node scripts/build-teacher-ai-assessment-bank.mjs [--check|--sync-html|--sync-all]");
}
